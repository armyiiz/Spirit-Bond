...
// [FIXED] Added missing starters (Tori, Sprout, Robo)
...
export const EVOLUTIONS: Monster[] = [
  ...
  // (หมายเหตุ: ถ้าต้องการร่าง Evo ของ Jelly, Tori, Sprout, Robo บอกได้เลยนะครับ เดี๋ยวผมเจนฯ เพิ่มให้!)
];
