...
### Phase 8: กระเป๋าใหม่และเศรษฐกิจ (Bag 2.0 & Economy - Patch 3.2)
*   **Bag 2.0:**
    *   แยก Tab ในกระเป๋าเป็น 3 หมวด: **ใช้งาน (Consumable)**, **วัสดุ/วิวัฒนาการ (Evo)**, และ **สวมใส่ (Equip)**
    *   เพิ่ม UX ให้ผู้เล่นตรวจสอบวัตถุดิบและหิน Evo ได้ในที่เดียว
*   **Boss Drop Economy Overhaul:**
    *   เปลี่ยนราคาขาย **Boss Drops** (วัตถุดิบจากบอส) เป็น **100 Spirit Tokens** (จากเดิมเป็น Gold)
    *   สร้างระบบ **Pity System:** ผู้เล่นที่ดวงไม่ดี (ตีบอสแล้วของไม่ตก) สามารถนำ Tokens ที่สะสมจาก Raid มาแลกซื้อวัตถุดิบได้
    *   ปรับปรุง UI ร้านค้าให้แสดงหน่วยเงิน (T/G) และสีปุ่ม (ม่วง/ฟ้า) ให้สอดคล้องกับประเภทไอเทม
*   **Bug Fixes & Improvements:**
    *   **Logic Fix:** เพิ่ม Guard Clause ใน `useItem` ป้องกันการเผลอกดใช้ไอเทมที่ไม่ใช่อาหาร (เช่น เผลอกินหิน หรืออาวุธ)
    *   **Code Quality:** ปรับปรุงการจัดการ Inventory State ให้เป็น Immutable Object เพื่อลดบั๊กการแสดงผล
